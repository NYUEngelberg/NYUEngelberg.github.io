...
[^28]:
    The Metropolitan Museum of Art's 150th Anniversary brand partnerships brought works from the Met's collection to limited edition items produced by brand partners. The program is an example of an institution leveraging its own brand to create commercial partnership based on open access content.  _See_ Michael Weinberg, _New Met Partnership Shows Open Access Can Coexist With Revenue?_, MichaelWeinberg.org (September 3, 2020), [https://michaelweinberg.org/ blog/2020/09/03/ met-brand-partner/](https://michaelweinberg.org/blog/2020/09/03/met-brand-partner/)
